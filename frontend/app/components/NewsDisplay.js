import { SafeAreaView, View, Text, Image, ImageBackground, Linking, StyleSheet } from "react-native";

function NewsDisplay({ author, image, text, title, link, date }) {
